...
Shader "MatCap/Bumped/Textured Add"
{
	Properties
	{
		...
		_SpeRange ("Specular Range", Range(0.0, 5.0)) = 1.0
		_MatCap ("MatCap (RGB)", 2D) = "white" {}
        _Color("Color", Color) = (1,1,1,1)     
        _AfterTex("_AfterTex", 2D) = "white" {}    
        _AfterColor ("After Color", Color) = (0.392,0.529, 0.69, 0.419)    
		_Liangdu("liangdu",float) = 0.2
	}
	
	Subshader
	{

		Tags { "Queue"="Geometry+401"}
